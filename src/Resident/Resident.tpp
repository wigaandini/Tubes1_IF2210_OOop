...
void Resident::harvest(T &source, map<string, U> &config, map<string, vector<string>> harvestResult, const string &name)
{
    if (source.isEmpty())
    {
        cout << endl
...
void Resident::placeTo(T &target, map<string, X> &config, function<bool()> checkInventory, const string &name)
{
